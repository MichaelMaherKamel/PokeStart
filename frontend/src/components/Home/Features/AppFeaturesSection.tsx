...
export function AppFeaturesSection() {
  ...
  const features = [
    {
      icon: (
        <svg viewBox='0 0 128 128' style={{ width: '48px', height: '48px' }}>
          <defs>
            <linearGradient
              id='a'
              x1='27.5'
      ...
      title: 'SolidJS Speed',
      description: 'Experience lightning-fast performance with the power of SolidJS reactivity.',
    },
    {
      icon: (
        <svg viewBox='0 0 128 128' style={{ width: '48px', height: '48px' }}>
      ...
      title: 'Go Backend',
      description: 'Powered by Go high-performance backend for reliable and lightning-fast data processing.',
    },
  ]
